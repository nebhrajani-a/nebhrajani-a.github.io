...
#+HTML: <div class="post-meta"> <2020-08-20 Fri> - 4 min read
#+HTML: </div>
...
* Introduction
  ...
  I'll say this outright: I'm not for the measures taken by the recent
  educational reform. Hear me out.

  The changes in the system are quite clearly mimicking the K-12
  educational systems abroad, and in particular, that of the USA. The
  divisions between preschool, elementary, middle, and high, along with
  the combined entrance test for colleges is the same. Moreover, the way
...
* Easier Isn't Necessarily Better
  ...
  Indian-educated Indians are leading technical fields, and it's this
  very rigour and way of doing things. To anybody who disagrees, compare
  the difficulty of the APs of the USA and the JEE. While we're not
  perfect, we are doing purely technical education better than the West,
  and that makes us a formidable country. What the USA does do better
  than us is college education, from undergraduate degrees through post
  docs. If anything, we should aim to mimic those.
...
* The Cold Never Bothered Me Anyway
  ...
  value is recognised when professional work is being done in the
  field and someone comes up with an elegant solution as a result of
  years of practice. The cold we felt doesn't bother us any more: we
  embrace it.
  ...
  shallow short term dreams. Any subject becomes fun when you dive
  deep into it. Is learning the alphabet expected to be fun, or is
  reading Harry Potter? The shift to a K-12 education system like that
  of the West will mean we surrender our single biggest advantage as a
  developing nation: knowing subjects more deeply than our Western
  counterparts studying less rigorous curricula. For all the jokes
  about Indians aping the British by wearing suits, we still are
  mimicking the West, despite our own model already being reasonably
  successful.
...
* Patriotism
  ...
  that cripples the children going through it? A system which will
  never teach them to deal with pressure, that will trick them into
  thinking they are competent when they are not, a system, in essence,
  that encourages mediocrity and takes away from India's youth the one
  thing we have: excellence and common sense in a fine blend, even
  though we may not have the resources of the West.
  ...
  unemployable, because they've never been tested, never faced
  pressure, and exist solely as BPO/call center employees.


* Conclusion

  I won't comment on the political angle, that of making a big move
  right before elections that the public will like, given that I am
  neither an expert nor an active follower of Indian politics. What I
  will say, however, is that you can read this. You know, inside you,
  that making education easier isn't how we're going to succeed as a
  nation. Doing things the long hard way sucks, but ultimately,
  someone has to do it. If you feel pride in a fellow Indian's
  achievement, seeing Pichai on stage and Mangalyaan on Mars, you
  should already know by now: making things easier isn't the way to
  go.
